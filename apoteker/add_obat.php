...
if (isset($_POST['submit'])) {
    ...
    $satuan = $_POST['satuan'];
    $stok = $_POST['stok'];
    $sql = "INSERT INTO tb_obat (kode_obat, nama_obat,jenis_obat,dosis_aturan_obat,satuan,stok) VALUES ('$kode_obat', '$nama_obat','$jenis_obat','$dosis_aturan_obat','$satuan','$stok')";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stok" class="form-control" placeholder="stok" name="stok">
                                </div>
                            </div>
