...
<div style='position: relative;'>
    ...
    <div style='text-align: center; margin-top: 10px;'>
        <p style='font-family: Arial; font-size: 15px; text-transform: uppercase;'><b>PEMERINTAH KOTA SORONG</b></p>
        <p style='font-family: Arial; font-size: 15px; text-transform: uppercase;'><b>DINAS KESEHATAN KOTA SORONG</b></p>
        <p style='font-family: Arial; font-size: 10px;'><b>Malawei, Kecamatan Sorong Manoi, Kota Sorong, Papua Bar. 98412</b></p>
    </div>
</div>
