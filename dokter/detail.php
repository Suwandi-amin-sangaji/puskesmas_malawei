                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="first-name" class="form-control" value="<?= $row['no_bpjs']; ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label>Poli</label>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="email-id" class="form-control" value="<?= $row['hasil_periksa'] ?>" readonly>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="email-id" class="form-control" value="<?= $row['nama_obat'] ?>" readonly>
                            </div>
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <a href="pemeriksaan" class="btn btn-danger me-1 mb-1">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
