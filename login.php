...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($koneksi, "SELECT * FROM tb_users WHERE email ='$email' AND password='$password'");
  $row = mysqli_fetch_assoc($query);

  if ($row) {
    // Login berhasil
    $_SESSION['email'] = $row['email'];
    $_SESSION['username'] = $row['username']; // Simpan email dalam session
  ...
  <div class="login-container">
    ...
    <form method="POST" class="form login" action="">
      ...
      <div class="login-actions-container">
        ...
        <a class="forgot-password" href="register">Register?</a>
        <a class="forgot-password" href="lupa_password">Lupa Password?</a>
