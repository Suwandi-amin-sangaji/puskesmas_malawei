                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row['alamat'] ?></td>
                                    <td>
                                        <a href="detail_pasien?id_user=<?= $row['id_user']; ?>" class="btn btn-success btn-sm block">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="cetak/cetak_kartu?id_user=<?= $row['id_user']; ?>" class="btn btn-warning btn-sm block">
