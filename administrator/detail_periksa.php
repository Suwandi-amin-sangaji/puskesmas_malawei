...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tb_pengeluaran_obat (no_terima_obat, nama_pasien, kode_obat, id_user, nama_obat, jenis_obat, dosis_aturan_obat, jumlah, satuan, keterangan, tgl_serah_obat) 
                  VALUES ('$no_terima_obat', '$nama_pasien', '$kode_obat', '$id_user', '$nama_obat', '$jenis_obat', '$dosis_aturan_obat', '$jumlah', '$satuan', '$keterangan', '$tgl_serah_obat')";
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="last-name-column" name="id_user" value="<?= $row['id_user']; ?>" class="form-control">
