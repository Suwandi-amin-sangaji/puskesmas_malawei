...
if (isset($_POST['submit'])) {
    ...
    $satuan = $_POST['satuan'];
    $stok = $_POST['stok'];
    $sql = "UPDATE tb_obat SET kode_obat = '$kode_obat', nama_obat = '$nama_obat', jenis_obat = '$jenis_obat',  dosis_aturan_obat = '$dosis_aturan_obat', satuan = '$satuan',stok = '$stok' WHERE kode_obat = '$kode_obat'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stok" class="form-control" value="<?= $row['stok']?>" name="stok">
                                </div>
                            </div>
