...
<div class="content-wrapper container">
    <div class="page-heading">
        <h3>Hasil pemeriksaan Dokter</h3>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($row['status_periksa'] == 'Sudah Diperiksa') : ?>
                                            <button class="btn btn-success btn-sm" disabled><i class="fa fa-check"></i> Sudah Diperiksa</button>
                                        <?php else : ?>
                                            <button class="btn btn-danger btn-sm" disabled><i class="fa fa-times"></i> Belum Diperiksa</button>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <a href="detail_periksa?no_registrasi=<?= $row['no_registrasi']; ?>" class="btn btn-primary btn-sm">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                </tr>
